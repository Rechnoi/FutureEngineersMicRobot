...
### Лидар
  В нашем роботе используется Lidar LD06. Он основан на принципе лазерной триангуляции расстояния и использует высокоскоростное оборудование для сбора и обработки данных, разработанное компанией Slamtec. Система измеряет данные о расстоянии более 4500 раз в секунду. Ядро LDRobot LD 06 вращается по часовой стрелке и выполняет всенаправленное 360-градусное лазерное сканирование окружающего пространства. Полученные данные преобразуются MCU для построения виртуальных стен.
