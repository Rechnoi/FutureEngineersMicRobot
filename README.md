...
## Сборка робота
  ...
  - В-пятых, открыв в Fusion 360 файл "3D-models/MicRobot V1.0/rro.f3d", соберите робота, как показано на модели.
...
### Мотор Bringsmart N20
  Этот мотор-редуктор представляет собой миниатюрный двигатель постоянного тока средней мощности с обмоткой на 12 В и металлическим редуктором. Его поперечное сечение составляет 10 × 24 мм, а обратный редуктор с D-образный выходным валом редуктора, имеющим длину 9 мм и диаметр 3 мм.
